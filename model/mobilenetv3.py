...
def _mobilenet_v3_model(
    ...
    **kwargs: Any
    ...
    if pretrained:
        ...
        state_dict['classifier.3.weight'] = state_dict['classifier.3.weight'][:kwargs['num_classes'], :]
        state_dict['classifier.3.bias'] = state_dict['classifier.3.bias'][:kwargs['num_classes']]
